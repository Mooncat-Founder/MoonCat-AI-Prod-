...
async function main() {
    ...
    try {
        ...
        // Create the transaction data for unpausing
        const tokenSaleInterface = new ethersLib.utils.Interface([
            "function unpause() external"
        ]);
        const unpauseData = tokenSaleInterface.encodeFunctionData("unpause", []);
        ...
        console.log('Data:', unpauseData);
        console.log('Signature bytes:', signatureBytes);

        console.log('Executing unpause transaction...');
