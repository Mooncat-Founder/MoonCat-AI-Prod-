...
async function migrateStakingContract() {
  ...
  console.log("Safe has all required roles. Would you like to revoke deployer roles?");
  console.log("IMPORTANT: Only do this if you are sure the Safe is properly configured!");
  console.log("To revoke roles, uncomment the role revocation code in the script.");
  
  // Uncomment the following block to revoke deployer roles
  /*
